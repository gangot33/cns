...
public class HillCipher {
    ...
    // Find the determinant of a 2x2 or 3x3 matrix
    ...
    // Generate the inverse key matrix
    public static void generateInverseKeyMatrix(int size) {
        ...
        det = (det < 0) ? det + 26 : det; // Ensure determinant is positive
        int detInverse = modInverse(det, 26);
        if (detInverse == -1) {
            System.out.println("Matrix is not invertible (no modular inverse for determinant).");
            System.exit(1);
        }
